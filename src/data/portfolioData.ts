...
export const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    description: 'Shipped 2 Game Jam titles, a sustainability theme game for GreenMate, and a completed 6-DoF VR title with collaborative team workflows on GitHub.',
    achievements: [
      'Shipped 2 distinct games built during Game Jam sprints with rapid scoping and team coordination.',
      'Developed an interactive eco-challenge game for the GreenMate initiative.',
      'Built a complete 6-DoF VR game.',
