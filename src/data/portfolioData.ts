...
export const personalInfo: PersonalInfo = {
  ...
  bio: 'I build immersive games and scalable software systems with modern AI workflows, and I love what I do. Computer Engineering student at Politecnico di Torino developing with Unity & C# since 2021.',
...
export const servicesData: ServiceItem[] = [
  {
    ...
    description: 'Developing complete game loops, VR interaction systems, and indie Game Jam releases with clean, modular codebases.',
    iconType: 'game',
  ...
  },
  {
    ...
    count: 'Modern Tooling',
    description: 'Integrating intelligent developer tools (such as the Antigravity AI tool) into production pipelines for accelerated iteration.',
    iconType: 'ai',
    bgColor: '#F5AF38', // Warm Amber / Mustard
  },
  {
    id: 'architecture-collaboration',
    title: 'Architecture & Group Collab',
    count: 'Scalable & Team-Ready',
    description: 'Building scalable architectures across diverse domains, practical 2D/3D & lighting knowledge, and fluent Git/GitHub team workflows.',
    iconType: 'code',
...
export const recognitionsData: RecognitionItem[] = [
  ...
  },
  {
    ...
    quote: 'Graduated with a 95.73/100 grade point average, demonstrating strong academic foundation in advanced mathematics and science.',
    year: '2022',
    tag: 'Academic Honors',
    avatarText: 'BS',
  },
...
export const timelineData: TimelineItem[] = [
  {
    ...
    description: 'Pursuing Bachelor of Science in Computer Engineering at Politecnico di Torino, focusing on software systems, computer architecture, and scalable software design.',
    achievements: [
      'Core coursework in computer architecture, software engineering, and computational systems.',
      'Active collaboration in multidisciplinary student engineering and software initiatives.',
    ],
  ...
  },
  {
    ...
    location: 'Torino, Italy',
    type: 'project',
    typeLabel: 'Active Focus',
    description: 'Integrating the Antigravity AI tool into Unity 3D development workflows to build scalable gameplay architectures, modular state machines, and dynamic camera systems.',
    achievements: [
      'Integrated Antigravity AI tooling into the development pipeline to accelerate prototyping and behavior logic.',
      'Architected decoupled C# state machines and scalable gameplay frameworks for diverse project requirements.',
      'Applied practical 3D lighting and environment setups to support visual clarity and gameplay feedback.',
    ],
    skills: ['Unity 3D', 'C#', 'AI Integration', 'Antigravity Tool', 'Scalable Architecture'],
    accentColor: 'teal',
  },
  {
    id: 'game-jams-vr-greenmate',
    period: '2021 - 2024',
    title: 'Indie Games, VR & Team Collaborations',
    organization: 'Itch.io & Independent Releases',
    location: 'Remote',
    type: 'project',
    typeLabel: 'Shipped Works',
    description: 'Shipped 3 Game Jam titles, a sustainability game for GreenMate, and a completed 6-DoF VR title with collaborative team workflows on GitHub.',
    achievements: [
      'Shipped 3 distinct games built during Game Jam sprints with rapid scoping and team coordination.',
      'Developed an interactive eco-challenge game for the GreenMate initiative.',
      'Built a complete 6-DoF VR game with physics-based hand interactions and comfort locomotion.',
      'Collaborated effectively using Git branching, pull requests, and multi-developer project sync.',
    ],
    skills: ['Unity Engine', 'C#', 'Unity XR (VR)', 'Team Collaboration', 'GitHub Workflows', '3D / Lighting Basics'],
    accentColor: 'orange',
  },
  {
    ...
    achievements: [
      'Built playable gameplay loops with responsive player mechanics and modular code design.',
      'Participated in team hackathons and collaborative code reviews.',
    ],
  ...
  },
  {
    ...
    description: 'Awarded the international ESP certification after co-founding a student enterprise, managing product delivery, and advancing to national finals.',
    achievements: [
      'Earned the JA Europe Entrepreneurship Skills Pass certification.',
      'Managed product development, pitch presentations, and cross-functional team coordination.',
    ],
    skills: ['Leadership', 'Entrepreneurship', 'Product Strategy', 'Team Coordination'],
    accentColor: 'blue',
  },
  {
    id: 'icyss-awards',
    ...
    achievements: [
      'Recognized for rigorous data analysis and fluent scientific English presentation.',
    ],
